...
describe('Surebet Calculator (Cross-Bookmaker)', () => {
  it('should find a profitable surebet across two bookmakers in a 2-way market', () => {
            ...
            markets: [
              {
                key: 'h2h',
                outcomes: [
                  { name: 'Nadal', price: 2.1 },
                  { name: 'Federer', price: 1.7 },
                ],
              },
            ],
          },
    ...
    // Margem: 1/2.1 (Betano) + 1/2.15 (Betfair) = 0.476 + 0.465 = 0.941 (Lucro de ~6.2%)
    ...
    expect(nadalLeg?.price).toBe(2.1)
            ...
            markets: [
              {
                key: 'h2h',
                outcomes: [
                  { name: 'Nadal', price: 1.9 },
                  { name: 'Federer', price: 1.9 },
                ],
              },
            ],
          },
  ...
  it('should handle 3-way markets (1X2) correctly', () => {
            ...
            markets: [
              {
                key: 'h2h',
                outcomes: [
                  { name: 'Chelsea', price: 3.5 }, // Home
                  { name: 'Arsenal', price: 2.1 }, // Away
                  { name: 'Draw', price: 3.0 }, // Draw
                ],
              },
            ],
          },
            ...
            markets: [
              {
                ...
                outcomes: [
                  ...
                  { name: 'Arsenal', price: 3.3 }, // Away (Bet on Arsenal here)
                  { name: 'Draw', price: 3.6 }, // Draw (Bet on Draw here)
                ],
              },
            ],
          },
    ...
    // Draw: 3.6 (Sportingbet) -> 1/3.6 = 0.2777
